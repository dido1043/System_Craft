...
namespace SystemCraftAPI.Model.Entities
{
    public class Printer
    {
        ...
        [StringLength(20)]
        public string Type { get; set; } // e.g., Inkjet, Laser

        [StringLength(20)]
        public string PrintTechnology { get; set; } // e.g., Color, Black & White

        [Range(1, int.MaxValue)]
        public int PrintSpeed { get; set; } // pages per minute

        [StringLength(20)]
        public string Resolution { get; set; } // e.g., 1200x1200 DPI

        public bool IsWireless { get; set; }

        [StringLength(20)]
        public string Connectivity { get; set; } // e.g., USB, WiFi
        ...
        [StringLength(20)]
        public string PaperSize { get; set; } // e.g., A4, Letter
